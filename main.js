...
class Bot {
  ...
  willBuyPropertey() {
    console.log('not final logic, probobly sucky')
    let cash=this.cash
    var numOnCurrentColor=null
    var thisColor=this.location.propertey.color
    var i=0
    if(this.location)
    if(thisColor=this.properties[i].propertey.color){
      numOnCurrentColor++
      i++
    }else {
      i++
...
communityChests = [
  function () {
    onSquare(turnBot, board[0]);
  },
  function () {
    turnBot.changeMoney(200);
  },
  function () {
    chargeTax(-50, turnBot);
  },
  function () {
    turnBot.changeMoney(50);
  },
  function () {
    turnBot.changeMoney(50);
  },
  ...
  function () {
    turnBot.changeMoney(100);
  },
  function () {
    turnBot.changeMoney(20);
  },
  function () {
    turnBot.changeMoney(30);
  },
  function () {
    turnBot.changeMoney(100);
  },
  function () {
    chargeTax(-100, turnBot);
  },
  function () {
    chargeTax(-50, turnBot);
  },
  function () {
    turnBot.changeMoney(25);
  },
  function () {
    turnBot.changeMoney(-40 * turnBot.houses);
  },
  function () {
    turnBot.changeMoney(10);
  },
  function () {
    turnBot.changeMoney(100);
  },
...
chances = [
  function () {
    onSquare(turnBot, board[39]);
  },
  function () {
    onSquare(turnBot, board[0]);
  },
  function () {
    onSquare(turnBot, board.indexOf(illinois));
  },
  function () {
    onSquare(turnBot, board.indexOf(stCharles));
  },
  function () {
    moveToNearest(turnBot, true);
  },
  function () {
    moveToNearest(turnBot, true);
  },
  function () {
    moveToNearest(turnBot, false);
  },
  function () {
    turnBot.changeMoney(-50);
  },
  ...
  function () {
    chargeTax(15, turnBot);
  },
  function () {
    onSquare(turnBot, board.indexOf(reading));
  },
  function () {
    chargeTax(150, turnBot);
  },
  function () {
    turnBot.changeMoney(150);
  },
];
console.log(chances);
...
function doTurn(turnBot) {
  ...
  if (turnBot.willBuyHouse) {
    if (turnBot.location.houses >= 5) {
      ...
      console.error(
        'figure out how to spread the houses across the color group'
      );
    }
  } //FIGURE OUT HOW TO DO JAIL
  //I think that roll system sucks, fix it later
  var roll = turnBot.roll()[0];
  ...
  while (counter < 4) {
    if (roll[1] === true) {
      ...
      roll = turnBot.roll()[0];
      onSquare(turnBot, turnBot.location + roll);
      turnBot.cash -= turnBot.location.propertey.rent[turnBot.houses];
      console.error(
        'YOU NEED TO GIVE THE BOARD SPOTS OWNER ATTRIBUTES TO TRACK WHO TO PAY'
      );
      if (counter === 3) {
        sendToJail(turnBot);
        break;
